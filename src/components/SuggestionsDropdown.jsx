        ...
        <div className="suggestions-dropdown desktop-only" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="dropdown-menu glass-panel">
                    <a href={new_emoji_form} target="_blank" rel="noopener noreferrer" className="dropdown-item">
                        <span>New Emote</span>
                        <ExternalLinkIcon />
                    </a>
                    <a href={suggestion_form} target="_blank" rel="noopener noreferrer" className="dropdown-item">
                        <span>General Suggestion</span>
                        <ExternalLinkIcon />
                    </a>
                    <a
                        href={edit_emote_form("", "", "", "", "", "", "")}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="dropdown-item"
                    >
                        <span>Edit Emote</span>
                        <ExternalLinkIcon />
                    </a>
                </div>
            )}
